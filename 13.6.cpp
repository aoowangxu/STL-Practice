/*************************************************************************
	...
	> Created Time: Sat 11 Jun 2016 03:31:35 AM EDT
 ************************************************************************/
...
template <class op1, class op2> class compose_f_gx_t: public std::unary_function<typename op2::argument_type, typename op1::result_type>
{
private:
    op1 myop1;
    op2 myop2;
